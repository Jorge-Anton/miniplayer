...
class Miniplayer extends StatefulWidget {
  ...
  final ValueNotifier<double>? dragDownPercentage;
  ...
  const Miniplayer({
    ...
    this.valueNotifier,
    this.dragDownPercentage,
    this.duration = const Duration(milliseconds: 300),
    this.onDismiss,
    this.onDismissed,
    this.controller,
    this.tapToCollapese = true,
  }) : super(key: key);
...
class _MiniplayerState extends State<Miniplayer> with TickerProviderStateMixin {
  ...
  late ValueNotifier<double> dragDownPercentage;
              ...
              Align(
                ...
                child: SizedBox(
                  ...
                  child: GestureDetector(
                      ...
                      builder:
                        ...
                        return Opacity(
                          ...
                          child: Transform.translate(
                            offset: Offset(0.0, widget.minHeight * value),
                            child: child,
                          ),
                        );
                      },
                    ...
                    onTap: () =>
                      _dragHeight == widget.maxHeight && !widget.tapToCollapese 
                        ? null
